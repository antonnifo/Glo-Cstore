...
<h2 class="w3_inner_tittle">Manage Hotels</h2>
<!-- tables -->
...
<a href="add_hotel.php"class="btn btn-primary btn-flat btn-pri" id="noPrint"> <i class="fa fa-user"></i> Add Hotel </a>
...
<?php
                      ...
                      <tr>
                        ...
                        <td id="noPrint"><a href="edit_hotel.php?id=<?php echo $row["id"]; ?>"class="btn btn-flat btn-pri btn-primary"> <i class="fa fa-pencil"></i> Edit</a> </td>
                        <td id="noPrint"><a href="delete_hotel.php?id=<?php echo $row["id"]; ?>"class="btn btn-flat btn-pri btn-danger"> <i class="fa fa-trash"></i> Delete </a> </td>
                      </tr>
                       <?php $count++;
                    } ?>
                </tr>
